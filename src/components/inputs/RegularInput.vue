...
<template>
    <div :class="{'pointer-events-none opacity-70': props.disabled === true,'text-red': hasError}">
        <div class="relative">
            ...
            <input :class="inputClasses" class="h-10 border-b pt-7 pb-4 focus:outline-none transition-colors" :id="id" :type="props.type" ref="inputRef" :value="props.modelValue" :disabled="props.disabled" @input="updateValue" @focusin="focus = true" @focusout="focus = false" />
